  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600 '>
        ...
        <h1 className='text-2xl sm:text-5xl font font-semibold max-w-2xl mx-auto text-gray-800'>{data.title}</h1>
        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto' >
          ...
          <div className='flex flex-col gap-4'>
            {comments.map((item, index)=>(
              <div key={index} className='relative bg-primary/2 border border-primaru/5 max-w-xl p-4 rounded text-gray-600'>
                <div className='flex items-center gap-2 mb-2'>
               
                  <img src={assets.user_icon} alt="" className='w-6' />
                  <p className='font-medium'>{DataTransferItemList.name}</p>
                </div>
